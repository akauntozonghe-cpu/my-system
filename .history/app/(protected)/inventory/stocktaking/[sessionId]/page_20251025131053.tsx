...
import ImportStocktaking from "./ImportStocktaking"; // ← 修正ポイント
...
export default function StocktakingSessionPage() {
  ...
  return (
    ...
    {mode === "full" && <FullStocktaking sessionId={sessionId} />}   {/* 修正 */}
    {mode === "partial" && <PartialStocktaking sessionId={sessionId} />} {/* 修正 */}
